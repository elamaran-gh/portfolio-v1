  ...
  return (
    <section id="projects" className="p-5 py-16 bg-gray-100">
      ...
      <div className="flex flex-col gap-10">
        ...
        {/* Card - MBBS AI Study Assistant */}
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition duration-300">

          <img src="mbbs.png" alt="MBBS AI Study Assistant" className="w-full h-56 object-cover blur-[2px] scale-105" />

          <div className="p-6">

            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-semibold">
                MBBS AI Study Assistant (Syllabus-Oriented RAG Study System)
              </h2>

              <div className="flex gap-3">
                <a href={"https://github.com/elamaran-gh/MBBS-Preparation-assitant"} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 px-3 py-2 bg-gray-100 rounded-lg hover:shadow-md hover:scale-105 transition">
                  <GitBranchPlus size={18} />
                  <span className="text-sm">Code</span>
                </a>

                <a href={"https://mbbs-preparation-assitant.vercel.app"} target="_blank" rel="noopener noreferrer"
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <span className="px-3 py-1 bg-gray-100 text-blue-600 rounded-lg text-sm">Qdrant Vector DB</span>
              <span className="px-3 py-1 bg-gray-100 text-blue-600 rounded-lg text-sm">RAG</span>
              <span className="px-3 py-1 bg-gray-100 text-blue-600 rounded-lg text-sm">PDF Processing</span>
            </div>
